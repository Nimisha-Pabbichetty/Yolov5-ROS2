...
bool ros_yolo__msg__custom_bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_yolo.msg._custom_bounding_box.CustomBoundingBox", full_classname_dest, 51) == 0);
  }
  ros_yolo__msg__CustomBoundingBox * ros_message = _ros_message;
  {  // probability
  ...
  {  // class1
    PyObject * field = PyObject_GetAttrString(_pymsg, "class1");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->class1, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of CustomBoundingBox */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_yolo.msg._custom_bounding_box");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CustomBoundingBox");
  ...
  {  // class1
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->class1.data,
      strlen(ros_message->class1.data),
      "strict");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "class1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
