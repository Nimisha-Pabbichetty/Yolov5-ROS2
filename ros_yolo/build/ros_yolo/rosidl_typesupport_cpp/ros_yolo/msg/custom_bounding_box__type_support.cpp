...
static const _CustomBoundingBox_type_support_symbol_names_t _CustomBoundingBox_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_yolo, msg, CustomBoundingBox)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_yolo, msg, CustomBoundingBox)),
  }
};
...
{
  return &::ros_yolo::msg::rosidl_typesupport_cpp::CustomBoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_yolo, msg, CustomBoundingBox)() {
  return get_message_type_support_handle<ros_yolo::msg::CustomBoundingBox>();
}
