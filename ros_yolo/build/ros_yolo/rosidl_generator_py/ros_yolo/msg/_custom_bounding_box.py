...
class Metaclass_CustomBoundingBox(type):
    """Metaclass of message 'CustomBoundingBox'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__custom_bounding_box
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__custom_bounding_box
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__custom_bounding_box
            cls._TYPE_SUPPORT = module.type_support_msg__msg__custom_bounding_box
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__custom_bounding_box
...
class CustomBoundingBox(metaclass=Metaclass_CustomBoundingBox):
    """Message class 'CustomBoundingBox'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.class1 = kwargs.get('class1', str())
    ...
    def class1(self, value):
        if __debug__:
            assert \
                ...
                "The 'class1' field must be of type 'str'"
        self._class1 = value
